                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <span class="btn mb-1 btn-sm btn-outline-success">
                                    ...
                                    <b><?=format_cash($CMSNT->get_row("SELECT COUNT(id) FROM `accounts` WHERE `product_id` = '".$product['id']."' AND `buyer` IS NOT NULL AND `status` = 'LIVE' ")['COUNT(id)']+$CMSNT->site('virtual_sold_quantity'));?></b>
                                </span>
                                <?php }?>
                ...
                <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="btn mb-1 btn-sm btn-outline-success">
                                    <i class="fas fa-cart-arrow-down mr-1"></i><?=__('Đã bán');?>:
                                    <b><?=format_cash($daban = $CMSNT->get_row("SELECT COUNT(id) FROM `accounts` WHERE `product_id` = '".$product['id']."' AND `buyer` IS NOT NULL AND `status` = 'LIVE' ")['COUNT(id)']+$CMSNT->site('virtual_sold_quantity'));?></b>
                                </span></td>
                            <?php }?>
                            <td class="text-center"><span class="btn mb-1 btn-sm btn-outline-danger">
                                    <i class="far fa-money-bill-alt mr-1"></i>
