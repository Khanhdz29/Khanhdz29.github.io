                                ...
                                <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel"
                                    ...
                                    <form action="" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Số lượng đã bán ảo</label>
                                                    <input type="number" class="form-control"
                                                        placeholder="Nhập số lượng ảo muốn tăng thêm (sl ảo + sl thật)"
                                                        name="virtual_sold_quantity"
                                                        value="<?=$CMSNT->site('virtual_sold_quantity');?>">
                                                    <i>SET thành 0 nếu muốn tắt chức năng này.</i>
                                                </div>
                                            </div>
                                            <?php endif?>
                                            <div class="col-lg-4">
